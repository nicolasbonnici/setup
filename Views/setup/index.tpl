{% extends 'layout.tpl' %} {% block meta_title %}Setup{% endblock
...
{% endblock %} {% block css %}
<link href="/lib/plugins/bootstrap-wysiwyg/css/bootstrap-wysiwyg.css"
    rel="stylesheet">
...
<div class="transparentBlackBg rounded well ui-shadow">
    <div class="row">
        <div class="col-md-12">
            <h1>
                Admin dashboard <small>configure your
                    installation</small>
            </h1>
        </div>
    </div>
        ...
        <div class="col-md-12 column">
            <div class="row clearfix">
                ...
                <div id="setupMain" class="col-md-9 column">
                    ...
                    <h3>Framework</h3>
                    <p>
                        Core version <strong>{{core_version}}</strong>
                        release name <strong>{{core_release_name}}</strong>
                    </p>
                    <p>
                        Le mode debug est actuellement <strong>{%
                            if sEnv === 'dev'%}activé{% else
