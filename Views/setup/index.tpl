            ...
            <div class="row clearfix">
                <div class="col-md-3 column">
                    <div class="list-group">
                        ...
                        <div class="list-group-item">
                            <span class="badge">14</span><span class="glyphicon glyphicon-question-sign"></span>
                            {{tr['support_center']}}
                        </div>
                    </div>
                </div>
                <div id="setupMain" class="col-md-9 column">
                    ...
                    <h3>Framework</h3>
                    <p>
                        Core version <strong>{{core_version}}</strong> release name <strong>{{core_release_name}}</strong>
                    </p>
                    <p>
